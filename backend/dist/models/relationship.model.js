...
const relationshipSchema = new mongoose_1.Schema({
    ...
    fromId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Person', required: true, index: true },
    toId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Person', required: true, index: true },
...
exports.RelationshipModel = mongoose_1.default.model('Relationship', relationshipSchema);
