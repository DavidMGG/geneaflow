<template>
  <form class="login-form" @submit.prevent="onSubmit" aria-describedby="login-help">
    <h2 class="form-title">Iniciar sesión</h2>
    <p id="login-help" class="form-description">Usa tu email y contraseña. Soporta recordar sesión.</p>
    ...
    <div class="form-footer">
      <p class="form-footer-text">
        ¿No tienes cuenta?
        <router-link to="/register" class="form-link form-link--primary">Crear cuenta</router-link>
      </p>
    </div>
  </form>
</template>
